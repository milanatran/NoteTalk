...
export declare class Server<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ServerSideEvents, EmitEvents, ServerReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
    ...
    constructor(srv?: http.Server | HTTPSServer | number, opts?: Partial<ServerOptions>);
    constructor(srv: undefined | Partial<ServerOptions> | http.Server | HTTPSServer | number, opts?: Partial<ServerOptions>);
    /**
     ...
     * @public
     */
    listen(srv: http.Server | HTTPSServer | number, opts?: Partial<ServerOptions>): this;
    /**
     * Attaches socket.io to a server or port.
     *
     * @param srv - server or port
     ...
     * @public
     */
    attach(srv: http.Server | HTTPSServer | number, opts?: Partial<ServerOptions>): this;
